...
ca_prop_plot <- nri_2 %>%
  ...
  scale_color_manual(values = c("FALSE" = "#4A7BA7", "TRUE" = "#bf4eb4")) +
  # Add labels 
  labs(title = "Proportion of High-Risk Counties: California vs. Top States", 
       x = "Proportion of High Risk Counties", 
       subtitle = "High-risk defined as FEMA Risk Index percentile > 84.32", 
 ...
 theme(axis.title.y = element_blank(), # Remove y label 
        ...
        plot.title = element_text(hjust = 0.5, size = 15, lwd = 1.5), 
...
I originally began with a bar chart to represent this data, however I chose a lollipop graph because it draws your eyes to the `geom_point` where you can read the proportion values clearly. I chose to represent
...
I wanted to implement a way to add a an annotattion of the California proportion value that is *only* on the California line and not the rest of the states. In addition, I wanted to change the color of California in the state y axes. 
